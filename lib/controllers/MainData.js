...
module.exports = Router().post('/', async (req, res, next) => {
  try {
    ...
    const dt1 = new DateCon(d, m, y); 
    const dt2 = new DateCon(todayDay, todayMonth, todayYear); 
    ...
    const hairGrowthPerYearInches = 6;
    ...
    const totalHairGrowth = (((totalNumOfDays / 365) * hairGrowthPerYearInches) / 12).toFixed(3);
